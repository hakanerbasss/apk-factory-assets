...
fun MainScreen() {
    ...
    if (GlobalApiState.warningType.isNotEmpty()) {
        AlertDialog(
            ...
            confirmButton = {
                if (GlobalApiState.warningType == "junior") {
                    Button(onClick = { GlobalApiState.warningType = ""; GlobalApiState.pendingAction = null; activeTab = AppTab.SETTINGS }, colors = ButtonDefaults.buttonColors(containerColor = ACCENT)) { Text("Ayarlara Git") }
                } else {
