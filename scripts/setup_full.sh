...
LOG_FILE="/sdcard/Android/data/com.wizaicorp.apkfactory/files/apkfactory_setup.log"
STATUS_FILE="/sdcard/Android/data/com.wizaicorp.apkfactory/files/apkfactory_status.json"
